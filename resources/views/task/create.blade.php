...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{route('project.show', $project)}}">Atividades</a></li>
...
@section('content')
    ...
    <div class="pt-5 pb-5 dark:bg-gray-800 overflow-hidden ">
        <form method="post" action="{{route('task.store', ['project_id' => $project])}}">
            @csrf
            ...
            <a href="{{route('project.show', $project)}}" class="btn btn-default">Voltar</a>
        </form>
    </div>
